...
public class SuppliesListRecyclerViewItemViewModelImpl
    implements SuppliesListRecyclerViewItemViewModel {
  ...
  @Inject public SuppliesListRecyclerViewItemViewModelImpl(
