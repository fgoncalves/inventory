package com.fred.inventory.presentation.supplieslist;
...
import com.fred.inventory.di.SuppliesListModule;
...
public class SuppliesListScreen extends BaseScreen {
  ...
  @Inject SuppliesListViewModel viewModel;
   ...
   */
  public static SuppliesListScreen newInstance() {
    return new SuppliesListScreen();
  }
   ...
   * @return The product list screen
   */
  public static SuppliesListScreen newInstance(String uuid) {
    SuppliesListScreen fragment = new SuppliesListScreen();
  ...
  @Nullable @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    MainActivity.scoped(new SuppliesListModule()).inject(this);
