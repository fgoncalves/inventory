...
public class SupplyItemScreen extends BaseScreen {
   ...
   */
  public static SupplyItemScreen newInstance(@NonNull String suppliesListId) {
    SupplyItemScreen supplyItemScreen = new SupplyItemScreen();

    Bundle args = new Bundle();
    args.putString(SUPPLIES_LIST_ID, suppliesListId);
    supplyItemScreen.setArguments(args);

    return supplyItemScreen;
  }
  ...
  @Nullable @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    MainActivity.scoped(new SupplyItemViewModule()).inject(this);
